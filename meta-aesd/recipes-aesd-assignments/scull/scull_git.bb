...
SRC_URI = "git://git@github.com/FinnHering/aeld-assignment-7.git;protocol=ssh;branch=main \
           ...
           file://files/981-scull-modules.sh \
           "
...
INITSCRIPT_NAME = "981-scull-modules.sh"
INITSCRIPT_PACKAGES = "${PN}"
INITSCRIPT_PARAMS = "defaults 99"

inherit module

FILES:${PN} += "${sysconfdir}/init.d/981-scull-modules.sh"
...
do_install() {
    ...
    install -m 0755 ${WORKDIR}/files/981-scull-modules.sh ${D}${sysconfdir}/init.d/981-scull-modules.sh
